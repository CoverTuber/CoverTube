...
public class CircleLoading: UIView {
    ...
    private func settup() {
        ...
        c1 = createCircle(radius: r1, lineWidth: baseWidth, startAngle: CGFloat(Double.pi * 0.8), endAngle: CGFloat(Double.pi * 1.2), color: color1.withAlphaComponent(0.5))
        
        let r2 = self.bounds.size.width / 2 - baseWidth * 0.5
        c2 = createCircle(radius: r2, lineWidth: baseWidth * 0.5, startAngle: CGFloat(Double.pi * 0.4), endAngle: CGFloat(Double.pi * 1.3), color: color2.withAlphaComponent(0.5))
        
        let r3 = self.bounds.size.width / 2 - baseWidth - 1
        c3 = createCircle(radius: r3, lineWidth: baseWidth, startAngle: CGFloat(Double.pi * 0.35), endAngle: CGFloat(Double.pi * 1.1), color: color1.withAlphaComponent(0.6))
        
        let r4 = self.bounds.size.width / 2 - baseWidth * 1.25
        c4 = createCircle(radius: r4, lineWidth: baseWidth * 0.5, startAngle: CGFloat(Double.pi * 0.2), endAngle: CGFloat(Double.pi * 0.9), color: color1.withAlphaComponent(0.6))
        
        let r5 = self.bounds.size.width / 2 - baseWidth * 0.3
        c5 = createCircle(radius: r5, lineWidth: baseWidth, startAngle: CGFloat(Double.pi * 0.25), endAngle: CGFloat(Double.pi * 0.7), color: color1.withAlphaComponent(0.4))
        
        let r6 = self.bounds.size.width / 2 - baseWidth - 1
        c6 = createCircle(radius: r6, lineWidth: baseWidth * 0.5, startAngle: CGFloat(-Double.pi * 0.2), endAngle: CGFloat(Double.pi * 0.45), color: color3.withAlphaComponent(0.8))
        
        let r7 = self.bounds.size.width / 2 - baseWidth * 0.6
        c7 = createCircle(radius: r7, lineWidth: baseWidth * 0.8, startAngle: CGFloat(-Double.pi * 0.1), endAngle: CGFloat(Double.pi * 0.2), color: color3.withAlphaComponent(0.8))
        
        let r8 = self.bounds.size.width / 2 - baseWidth * 0.2
        c8 = createCircle(radius: r8, lineWidth: baseWidth * 0.8, startAngle: CGFloat(-Double.pi * 0.6), endAngle: CGFloat(0), color: color1.withAlphaComponent(0.8))
        
        let r9 = self.bounds.size.width / 2 - baseWidth * 0.5
        c9 = createCircle(radius: r9, lineWidth: 1, startAngle: CGFloat(-Double.pi * 0.4), endAngle: CGFloat(-Double.pi * 0.2), color: UIColor.white)
    ...
    private func rotateAnimation(duration: CFTimeInterval, direction: Double = 1.0) -> CABasicAnimation {
        ...
        animation.toValue = CGFloat(direction * Double.pi * 2)
